  ...
  module Hex
    class UpdateChecker < Dependabot::UpdateCheckers::Base
      ...
      def latest_git_tag_is_resolvable?
        ...
        @latest_git_tag_is_resolvable_checked = T.let(true, T.nilable(TrueClass))
        ...
        @git_tag_resolvable = T.let(false, T.nilable(FalseClass))
      end
      ...
      sig { params(unlock_requirement: T.any(T.nilable(Symbol), T::Boolean)).returns(T.nilable(Dependabot::Version)) }
